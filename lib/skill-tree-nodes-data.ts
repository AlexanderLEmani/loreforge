  ...
  return [
    {
      ...
      description: `Базовый узел ветки ${labels.topicName}. Открывает атаки и защиты.`,
      effect: { kind: 'xp_bonus', value: 5, topic: t, detail: `+5% XP за задачи на ${labels.topicName}` },
      cost: 0, requires: null, position_x: 400, position_y: 300,
    },
    {
      ...
      cost: 1, requires: R, position_x: 260, position_y: 220,
    },
    {
      ...
      cost: 2, requires: R + 1, position_x: 160, position_y: 140,
    },
    {
      ...
      cost: 2, requires: R + 2, position_x: 80, position_y: 60,
    },
    {
      ...
      cost: 1, requires: R, position_x: 540, position_y: 220,
    },
    {
      ...
      cost: 2, requires: R + 4, position_x: 640, position_y: 140,
    },
    {
      id: R + 6, branch: t, name: labels.passive, type: 'passive', icon: '✦',
      description: `Постоянный бонус ветки ${labels.topicName}.`,
      effect: { kind: 'xp_bonus', value: 8, topic: t, detail: `+8% XP в теме «${labels.topicName}»` },
      cost: 2, requires: R, position_x: 400, position_y: 180,
    },
  ]
}
