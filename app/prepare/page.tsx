      ...
      <div style={{ maxWidth: '720px', margin: '0 auto', padding: '2rem' }}>
        <div style={{ marginBottom: '1.5rem' }}>
          ...
          <div style={{ fontSize: '14px', color: '#9590a8', lineHeight: 1.6 }}>
            Данж: <span style={{ color: '#c8c0d8' }}>{dungeonLabel}</span>.
            Возьми до {MAX_BATTLE_LOADOUT} расходников — зелья и руны из запаса.
          </div>
          <div style={{ marginTop: '10px', fontSize: '12px', color: '#7b6cff', lineHeight: 1.5 }}>
            ✦ Боевые заклинания выучиваются в лавке и всегда доступны в бою — сюда класть не нужно.
          </div>
        </div>
